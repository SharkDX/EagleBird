...
#ifndef NOISE_MODULE_MOUNTAINMODULE_H
#define NOISE_MODULE_MOUNTAINMODULE_H
...
namespace noise
{
	...
	namespace module
	{
		...
		///
		/// @image html moduleMountainModule.png
		///
		...
		/// (see the @a MountainModulefractal() function.)  This code was written by F.
		...
		class MountainModule : public Module
		{
